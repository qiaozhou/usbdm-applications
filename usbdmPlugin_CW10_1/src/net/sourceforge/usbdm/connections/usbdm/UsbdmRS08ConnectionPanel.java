 ...
 *
 */
public class UsbdmRS08ConnectionPanel 
...
//      paramILaunchConfigurationWorkingCopy.setAttribute(attrib(UsbdmCommon.KeyGuessSpeedIfNoSYNC),      (String)null);
   ...
   protected void createContents(Composite comp) {
      ...
      Composite composite_2a = new Composite(this, SWT.NONE);
      GridData gd_composite_2a = new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1);
      gd_composite_2a.heightHint = 16;
      composite_2a.setLayoutData(gd_composite_2a);
      composite_2a.setLayout(new FillLayout(SWT.VERTICAL));
      toolkit.adapt(composite_2a);
      toolkit.paintBordersFor(composite_2a);
