...
public class UsbdmCommon {
   ...
   public static final String UsbdmLibraryName_so      = "usbdm.4";
   public static final String UsbdmDebugLibraryName_so = "usbdm-debug.4";
 ...
 //!
   public static class BdmOptions {
    ...
    public int   targetClockFreq;          //!< - CFVx - Target clock frequency. \n
...
//    public static final String KeyTargetClockFrequency      = "targetClockFrequency"; // HCS12 may need these
//    public static final String KeyGuessSpeedIfNoSYNC        = "guessSpeedIfNoSYNC";
