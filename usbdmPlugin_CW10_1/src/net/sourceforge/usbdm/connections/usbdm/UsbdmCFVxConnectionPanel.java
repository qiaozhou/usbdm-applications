...
//         System.err.println("UsbdmCFVxConnectionPanel.restoreDefaultSettings() - ConnectionSpeed = "+CFVxDeviceData.ClockSpeed.defFrequency.toString());
...
//      System.err.println("UsbdmCFVxConnectionPanel.loadSettings()");
      ...
      try {
         ...
         btnUsePstSignals.setSelection(getIntAttribute(iLaunchConfiguration, attrib(UsbdmCommon.KeyUsePSTSignals),   defaultBdmOptions.cycleVddOnReset) != 0);
...
//      System.err.println("UsbdmCFVxConnectionPanel.saveSettings()");
      ...
      paramILaunchConfigurationWorkingCopy.setAttribute(attrib(UsbdmCommon.KeyUsePSTSignals),      btnUsePstSignals.getSelection()?"1":"0");
