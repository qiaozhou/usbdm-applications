...
#define OSBDM_API extern "C" WINAPI __declspec(dllexport)
...
USBDM_API unsigned int   _opensourcebdm_read_csr2_byte(void);
USBDM_API unsigned int   _opensourcebdm_read_csr3_byte(void);
...
USBDM_API void           _opensourcebdm_write_csr2_byte(unsigned char value);
USBDM_API void           _opensourcebdm_write_csr3_byte(unsigned char value);
