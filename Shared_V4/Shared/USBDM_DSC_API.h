...
extern "C" {
      ...
      #define USBDM_DSC_API WINAPI     __declspec(dllexport)
      ...
      #define USBDM_DSC_API WINAPI
   #else
      //! This definition is used when being imported (linking against DLL)
      #define USBDM_DSC_API WINAPI     __declspec(dllimport)
   #endif
#else
   #if defined(DLL)
      //! This definition is used when being exported (creating DLL)
      #define USBDM_DSC_API __attribute__ ((visibility ("default")))
   #else
      //! This definition is used when being imported etc
      #define USBDM_DSC_API
   #endif
#endif
