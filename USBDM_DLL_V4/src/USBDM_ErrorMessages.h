...
typedef enum  {
 ...
 BDM_RC_DEVICE_OPEN_FAILED                     = 8,     //!< BDM Open Failed
 //
 BDM_RC_UNKNOWN_TARGET                         = 15,    //!< Target not supported or unknown
 ...
 SFILE_RC_ELF_FORMAT_ERROR                     = 204 , //!< ELF file does not have the ecpected format
 SFILE_RC_UNKNOWN_FILE_FORMAT                  = 205 , //!< File is not recognised as ELF or SREC
} USBDM_ErrorCode;

#if defined(DLL)
// Only available internally to USBDM
